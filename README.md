...
<p align="center">
  ...
  <a href="YOUR_GITHUB_URL" target="_blank" rel="noopener noreferrer">
    <img src="GITHUB_ICON_URL" alt="GitHub" width="50" height="50">
  </a>
  <a href="YOUR_WEBSITE_URL" target="_blank" rel="noopener noreferrer">
    <img src="WEBSITE_ICON_URL" alt="Website" width="50" height="50">
  </a>
</p>

Languages and Tools:
aws bash bootstrap csharp docker dotnet firebase git illustrator java javascript linux mongodb mssql mysql nodejs php python react reactnative tailwind unity
